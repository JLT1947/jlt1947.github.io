		...
		function doResize() {
				/* Original Commented out by HarryCaper
                 document.getElementById('toc').style.height = parseInt(getInnerHeight() - 110) + 'px';
				*/
				 
				/* Ammendment by HarryCaper */
                 document.getElementById('toc').style.height = parseInt(getInnerHeight() - 90) + 'px';
				/* Original Commented out by HarryCaper	*/			  
